...
class Shader:
    ...
    def createShader(self, strings, type):
        ...
        strings = [s if isinstance(s, bytes) else s.encode('ascii') for s in strings]
    ...
    def uniformf(self, name, *vals):
        ...
        location = glGetUniformLocation(self.handle, name.encode('ascii'))
        func = (glUniform1f, glUniform2f, glUniform3f, glUniform4f)[len(vals) - 1]
        func(location, *vals)
    ...
    def uniformi(self, name, *vals):
        ...
        location = glGetUniformLocation(self.handle, name.encode('ascii'))
        func = (glUniform1i, glUniform2i, glUniform3i, glUniform4i)[len(vals) - 1]
        func(location, *vals)
